		...
		<div className="App">
			<Container className="main-container">
				<Row className="section1">
					...
					{user && user.googleId === profile.user_id ? <Col></Col> :
					<Col>
				...
				<Row className="section1"> 
					...
					<Row>
						<Col>
							...
							<Image
								className="role"
								src={"/images/role_photo/Position_Challenger-"+ profile.primary_role + ".png" }
								onError={({currentTarget}) => {
									currentTarget.onError = null;
									currentTarget.src="/images/role_photo/Position_Challenger-JGL.png";
								}}
								fluid/>
							</div>
						...
						<Col>
							...
							<Image
								className="role"
								src={"/images/role_photo/Position_Challenger-"+ profile.secondary_role + ".png"}
								onError={({currentTarget}) => {
									currentTarget.onError = null;
									currentTarget.src="/images/role_photo/Position_Challenger-JGL.png";
								}}
